...
//$_['datepicker']            = 'zh-hk';
//$_['datepicker']            = 'zh-tw';
			if (file_exists(DIR_MODIFICATION . "catalog/language/en-gb/octemplates/oct_showcase.php")) {
				include(DIR_MODIFICATION . "catalog/language/en-gb/octemplates/oct_showcase.php");
			} else {
				include(DIR_LANGUAGE."en-gb/octemplates/oct_showcase.php");
			}