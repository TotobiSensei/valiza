			...
			foreach ($results as $result) {
				...
				foreach ($category as $categories) {
					...
					if (isset($categories['blogcategory_id']) && $categories['blogcategory_id']) {
						$blog_category_info[] = $this->model_octemplates_blog_oct_blogcategory->getBlogCategory($categories['blogcategory_id']);
					}
				}
				
				foreach ($blog_category_info as $blog_name) {
					$blog_category[] = $blog_name['name'];
				}
