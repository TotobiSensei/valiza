...
class ControllerOCTemplatesEventsFooter extends Controller {
    ...
    private function checkIsiOS(&$data) {
        if ($this->registry->has('oct_mobiledetect')) {
            ...
            if (($oct_mobiledetect->isiOS() || $oct_mobiledetect->isiPad()) && ((isset($this->request->get['product_id']) && $this->request->get['product_id']) || ((isset($this->request->get['route']) && $this->request->get['route'] == 'common/home' || (isset($this->request->get['route']) && $this->request->get['route'] == 'checkout/oct_fastorder')) || $this->request->server['REQUEST_URI'] == '/'))) {
                $data['oct_isiOS'] = 1;
            }
        }
    }
