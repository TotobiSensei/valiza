...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		// $this->document->addStyle('catalog/view/theme/default/assets/css/bootstrap.min.css');
		// $this->document->addStyle('catalog/view/theme/default/assets/css/slick.css');
		// $this->document->addStyle('catalog/view/theme/default/assets/css/style.css');
		...
		// header buttons
		$info_ids = [6, 8, 10, 7, 28, 11];
		$info_btns = [];

		foreach ($info_ids as $index => $id)
		{
			$info_btns[$index]["name"] = $this->model_catalog_information->getInformation($id)["title"];

			$info_btns[$index]["href"] = $this->url->link("information/information", "information_id=$id");
		}
